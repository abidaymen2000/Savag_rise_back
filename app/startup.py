...
async def init_mongo():
    ...
    await db["analytics_events"].create_index([("event_category", 1), ("created_at", -1)], background=True)
    await db["analytics_events"].create_index([("device_type", 1), ("created_at", -1)], background=True)
    await db["analytics_events"].create_index([("page_path", 1), ("created_at", -1)], background=True)
    await db["analytics_events"].create_index([("action_target", 1), ("created_at", -1)], background=True)
    await db["analytics_events"].create_index([("utm_source", 1), ("created_at", -1)], background=True)
    await db["analytics_events"].create_index([("utm_medium", 1), ("created_at", -1)], background=True)
