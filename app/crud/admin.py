...
DEFAULT_CMS_PAGES = [
    ...
    {"key": "traffic", "label": "Trafic", "section": "VENTES", "path": "/admin/traffic", "icon": "activity", "order": 140, "is_active": True, "requires_permission": True},
    {"key": "analytics", "label": "Analytics", "section": "VENTES", "path": "/admin/analytics", "icon": "bar-chart-3", "order": 145, "is_active": True, "requires_permission": True},
